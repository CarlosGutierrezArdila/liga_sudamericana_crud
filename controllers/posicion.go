...
import (
	"encoding/json"
	"errors"
	"oas_sudamericana/liga_sudamericana_crud/models"
	"strconv"
	"strings"
...
// @Param	body		body 	models.Posicion	true		"body for Posicion content"
// @Success 201 {int} models.Posicion
// @Failure 400 the request contains incorrect syntax
// @router / [post]
func (c *PosicionController) Post() {
	var v models.Posicion
	if err := json.Unmarshal(c.Ctx.Input.RequestBody, &v); err == nil {
		if _, err := models.AddPosicion(&v); err == nil {
...
func (c *PosicionController) GetOne() {
	...
	v, err := models.GetPosicionById(id)
	if err != nil {
		logs.Error(err)
		//c.Data["development"] = map[string]interface{}{"Code": "000", "Body": err.Error(), "Type": "error"}
		c.Data["system"] = err
...
func (c *PosicionController) GetAll() {
	...
	l, err := models.GetAllPosicion(query, fields, sortby, order, offset, limit)
	if err != nil {
		logs.Error(err)
		//c.Data["development"] = map[string]interface{}{"Code": "000", "Body": err.Error(), "Type": "error"}
		c.Data["system"] = err
...
func (c *PosicionController) Put() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
	v := models.Posicion{Id: id}
	if err := json.Unmarshal(c.Ctx.Input.RequestBody, &v); err == nil {
		if err := models.UpdatePosicionById(&v); err == nil {
			c.Data["json"] = v
		} else {
			logs.Error(err)
			//c.Data["development"] = map[string]interface{}{"Code": "000", "Body": err.Error(), "Type": "error"}
...
func (c *PosicionController) Delete() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
	if err := models.DeletePosicion(id); err == nil {
